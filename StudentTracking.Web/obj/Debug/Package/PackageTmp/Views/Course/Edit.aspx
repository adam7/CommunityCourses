...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<fieldset>
		...
		<p>
			<label for="StartDate">
				Start Date:</label>
			<%= Html.TextBox("StartDate", String.Format("{0:dd/MM/yyyy}", Model.StartDate), new { @class = "st-date" })%>
		</p>
		<p>
			<label for="EndDate">
				End Date:</label>
			<%= Html.TextBox("EndDate", String.Format("{0:dd/MM/yyyy}", Model.EndDate), new { @class = "st-date" })%>
		</p>
		<p>
			<label for="TutorId">
				Tutor:</label>
