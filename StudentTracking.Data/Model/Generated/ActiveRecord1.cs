...
namespace StudentTracking.Data.Model
{
    ...
    public partial class Address: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Address>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        ...
        StudentTracking.Data.Model.StudentTrackingDB _db;
        public Address(string connectionString, string providerName) {

            _db=new StudentTracking.Data.Model.StudentTrackingDB(connectionString, providerName);
            Init();            
         }
        void Init(){
        ...
        public Address(){
             _db=new StudentTracking.Data.Model.StudentTrackingDB();
            Init();            
        }
        ...
        internal static IRepository<Address> GetRepo(string connectionString, string providerName){
            StudentTracking.Data.Model.StudentTrackingDB db;
            if(String.IsNullOrEmpty(connectionString)){
                db=new StudentTracking.Data.Model.StudentTrackingDB();
            }else{
                db=new StudentTracking.Data.Model.StudentTrackingDB(connectionString, providerName);
            }
            IRepository<Address> _repo;
        ...
        public IQueryable<Person> People
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.Person.GetRepo();
                  return from items in repo.GetAll()
                       where items.AddressId == _Id
                       select items;
            }
    ...
    public partial class Centre: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Centre>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public Address Address      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Address.GetRepo();
                  return (from items in repo.GetAll()
        ...
        public IQueryable<Course> Courses
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.Course.GetRepo();
                  return from items in repo.GetAll()
    ...
    public partial class Course: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Course>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public IQueryable<CourseModule> CourseModules
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.CourseModule.GetRepo();
                  return from items in repo.GetAll()
        ...
        public IQueryable<CourseSession> CourseSessions
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.CourseSession.GetRepo();
                  return from items in repo.GetAll()
                       where items.CourseId == _Id
                       select items;
            }
        ...
        public Tutor Tutor      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Tutor.GetRepo();
                  return (from items in repo.GetAll()
        ...
        public Unit Unit      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Unit.GetRepo();
                  return (from items in repo.GetAll()
        ...
        public Verifier Verifier      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Verifier.GetRepo();
                  return (from items in repo.GetAll()
    ...
    public partial class CourseModule: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<CourseModule>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public IQueryable<StudentCourseModule> StudentCourseModules
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.StudentCourseModule.GetRepo();
                  return from items in repo.GetAll()
        ...
        public Module Module      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Module.GetRepo();
                  return (from items in repo.GetAll()
    ...
    public partial class CourseSession: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<CourseSession>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public IQueryable<StudentCourseSession> StudentCourseSessions
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.StudentCourseSession.GetRepo();
                  return from items in repo.GetAll()
        ...
        public Session Session      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Session.GetRepo();
                  return (from items in repo.GetAll()
    ...
    public partial class Disability: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Disability>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Ethnicity: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Ethnicity>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    /// <summary>
    /// A class which represents the Gender table in the StudentTracking Database.
    /// </summary>
    public partial class Gender: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<Gender> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Gender>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<Gender> testlist){
            SetTestRepo();
            _testRepo._items = testlist;
        }
        public static void Setup(Gender item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
        ...
        StudentTracking.Data.Model.StudentTrackingDB _db;
        public Gender(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            if(TestMode){
                ...
                _repo = new SubSonicRepository<Gender>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public Gender(Expression<Func<Gender, bool>> expression):this() {
        ...
        internal static IRepository<Gender> GetRepo(string connectionString, string providerName){
            StudentTracking.Data.Model.StudentTrackingDB db;
            if(String.IsNullOrEmpty(connectionString)){
                db=new StudentTracking.Data.Model.StudentTrackingDB();
            }else{
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<Gender>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<Gender> GetRepo(){
            return GetRepo("","");
        }
        
        public static Gender SingleOrDefault(Expression<Func<Gender, bool>> expression) {
        ...
        public static Gender SingleOrDefault(Expression<Func<Gender, bool>> expression,string connectionString, string providerName) {
            var repo = GetRepo(connectionString,providerName);
            var results=repo.Find(expression);
            Gender single=null;
            if(results.Count() > 0){
        ...
        public static bool Exists(Expression<Func<Gender, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<Gender, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<Gender> Find(Expression<Func<Gender, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<Gender> Find(Expression<Func<Gender, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<Gender> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<Gender> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<Gender> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<Gender> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<Gender> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<Gender> GetPaged(int pageIndex, int pageSize) {
            return GetRepo().GetPaged(pageIndex, pageSize);
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(Gender)){
                Gender compare=(Gender)obj;
                return (int)compare.KeyValue()==(int)this.KeyValue();
            }else{
                return base.Equals(obj);
            }
        ...
        public static void Delete(Expression<Func<Gender, bool>> expression) {
            var repo = GetRepo();
    ...
    public partial class Module: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Module>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Person: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Person>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public Disability Disability      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Disability.GetRepo();
                  return (from items in repo.GetAll()
        ...
        public Ethnicity Ethnicity      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Ethnicity.GetRepo();
                  return (from items in repo.GetAll()
        ...
        public Gender Gender      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.Gender.GetRepo();
                  return (from items in repo.GetAll()
                       where items.Id == _GenderId
                       select items).SingleOrDefault();
            }
        ...
        public IQueryable<Student> Students
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.Student.GetRepo();
                  return from items in repo.GetAll()
    ...
    public partial class Placement: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Placement>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public PlacementLocation PlacementLocation      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.PlacementLocation.GetRepo();
                  return (from items in repo.GetAll()
        ...
        public PlacementType PlacementType      
            ...
            get
            {
                  var repo=StudentTracking.Data.Model.PlacementType.GetRepo();
                  return (from items in repo.GetAll()
    ...
    public partial class PlacementLocation: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<PlacementLocation>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public IQueryable<Placement> Placements
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.Placement.GetRepo();
                  return from items in repo.GetAll()
    ...
    public partial class PlacementType: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<PlacementType>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Session: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Session>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Student: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Student>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public IQueryable<StudentTasterSession> StudentTasterSessions
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.StudentTasterSession.GetRepo();
                  return from items in repo.GetAll()
                       where items.StudentId == _Id
                       select items;
            }
    ...
    public partial class StudentCourseModule: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<StudentCourseModule>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class StudentCourseSession: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<StudentCourseSession>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class StudentTasterSession: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<StudentTasterSession>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class TasterSession: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<TasterSession>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Tutor: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Tutor>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Unit: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Unit>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Verifier: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Verifier>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
