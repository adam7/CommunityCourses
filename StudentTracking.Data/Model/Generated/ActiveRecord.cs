...
namespace StudentTracking.Data.Model
{
    ...
    public partial class Disability: IActiveRecord
    {
        ...
        public IQueryable<PersonDisability> PersonDisabilities
        {
            get
            {
                  ...
                  var repo=StudentTracking.Data.Model.PersonDisability.GetRepo();
                  return from items in repo.GetAll()
    ...
    public partial class PersonDisability: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<PersonDisability>(new StudentTracking.Data.Model.StudentTrackingDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
